      ...
      <section className="final-cta" id="cta">
        ...
        <div className="container">
          <div className="reveal">
            ...
            <a href="https://wa.me/5519996737713?text=Olá! Quero começar agora e parar de perder vendas." className="btn-primary" style={{fontSize:'1.1rem',padding:'18px 36px',marginBottom:'8px'}}>
      ...
      <footer>
        <div className="container">
          ...
          <div className="footer-copy">
            <p>&copy; 2026 Zapvai. Todos os direitos reservados. Desenvolvido com <span>♥</span> por Ignotec</p>
